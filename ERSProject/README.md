...
This project was implemented with with all of the required technologies including log4j and JUnit testing. 

The front end was developed as a SPA. Please find screenshots in the FrontEnd folder. 

Password encryption was handled by Java's Security package prior to storage in the database. 

Stretch goals of AWS RDS hosting of the database was also accomplished.